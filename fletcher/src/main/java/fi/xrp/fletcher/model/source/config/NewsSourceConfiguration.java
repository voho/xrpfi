...
public class NewsSourceConfiguration {
    ...
    private Stream<GenericRssNewsProducer> topXrpNews() {
        return Stream.of(
                GenericRssNewsProducer.builder().feedUrl("http://xrpcommunity.blog/rss/"),
                GenericRssNewsProducer.builder().feedUrl("http://ripple.com/category/insights/news/feed/"),
    ...
    private Stream<GenericRssNewsProducer> regularNews() {
        return Stream.of(
                ...
                GenericRssNewsProducer.builder().feedUrl("http://coinfunda.com/feed"),
                GenericRssNewsProducer.builder().feedUrl("http://coinjournal.net/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://coinpress.io/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://coinspeaker.com/feed"),
                GenericRssNewsProducer.builder().feedUrl("http://cointelegraph.com/rss"),
                GenericRssNewsProducer.builder().feedUrl("http://cryptobriefing.com/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://cryptocoinspy.com/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://cryptocrimson.com/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://cryptocurrencyfacts.com/blog/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://cryptocurrencynews.com/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://cryptodaily.co.uk/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://cryptoinsider.com/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://cryptoninjas.net/feed"),
                GenericRssNewsProducer.builder().feedUrl("http://cryptodailygazette.com/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://ethereumworldnews.com/feed/"),
                ...
                GenericRssNewsProducer.builder().feedUrl("http://usethebitcoin.com/feed"),
                GenericRssNewsProducer.builder().feedUrl("http://www.bitcoinmarketjournal.com/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://www.blockchain24.co/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://www.ccn.com/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://www.coininsider.com/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://www.coinspeaker.com/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://www.crypto-news.net/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://www.cryptocurrencyfreak.com/feed/"),
                ...
                GenericRssNewsProducer.builder().feedUrl("http://coinfomania.com/feed/"),
                GenericRssNewsProducer.builder().feedUrl("http://ripple-guide.com/category/xrp-news/feed"),
                GenericRssNewsProducer.builder().feedUrl("http://unchained.libsyn.com/unchained"),
                GenericRssNewsProducer.builder().feedUrl("http://feeds.finance.yahoo.com/rss/2.0/headline?s=xrp-usd&lang=en-US"),
                GenericRssNewsProducer.builder().feedUrl("http://feeds.finance.yahoo.com/rss/2.0/headline?s=xrp-btc&lang=en-US")
        )
                     .peek(a -> a.tag(NEWS))
                     .peek(a -> a.tag(NEEDS_FILTERING))
                     .map(GenericRssNewsProducer.GenericRssNewsProducerBuilder::build);
